  ...
  
{
...

  {
    ...
    header: "Weight",
    cell: ({ row }) => (
      <div className="capitalize">{row.getValue("packageWeight")}</div>
    ),
  },
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem onClick={()=>{ openModal(row) }} >View</DropdownMenuItem>
...
// const [rateData, setRateData] = React.useState({})
  ...
  const del = (id) => {
     ...
     axios.post(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/users/deletshipment`, {
       _id: id
     });
     window.location.reload()
     ...
     <div>
      ...
      >
        ...
        <form onSubmit={onSubmit} >
          ...
          <div>
            <p>
              <strong>Charges:</strong> {formData.charges}<br/>
              ...
              <strong>Package Count:</strong> {formData.packageCount}<br/>
              <strong>Package Type:</strong> {formData.packageType}<br/>
              <strong>Package Weight:</strong> {formData.packageWeight}<br/>
              <strong>Phone:</strong> {formData.phone}<br/>
              <strong>Postal Code:</strong> {formData.postalCode}<br/>
              <strong>Reciever:</strong> {formData.reciever}<br/>
              <strong>User:</strong> {formData.userid}<br/>
              <strong>State:</strong> {formData.state}<br/>
              <strong>Street:</strong> {formData.street}<br/>
              <strong>Tracking ID:</strong> {formData.trackingId}<br/>
